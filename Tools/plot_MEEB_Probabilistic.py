...
plot_most_probable_class_2(elev_class_probabilities, elev_class_cmap, elev_class_labels, it=-1)
...
most_likely_animation_2(elev_class_probabilities, elev_class_cmap, elev_class_labels)
